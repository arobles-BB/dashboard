...
// node_modules/.pnpm/@vaadin/text-area@22.0.2/node_modules/@vaadin/text-area/theme/lumo/vaadin-text-area-styles.js
var textArea = css`
  [part='input-field'],
...
// node_modules/.pnpm/@vaadin/field-base@22.0.2/node_modules/@vaadin/field-base/src/text-area-controller.js
var TextAreaController = class extends SlotController {
  constructor(host, callback) {
    super(host, "textarea", () => document.createElement("textarea"), (host2, node) => {
...
// node_modules/.pnpm/@vaadin/text-area@22.0.2/node_modules/@vaadin/text-area/src/vaadin-text-area.js
registerStyles("vaadin-text-area", inputFieldShared2, { moduleId: "vaadin-text-area-styles" });
var TextArea = class extends InputFieldMixin(ThemableMixin(ElementMixin(PolymerElement))) {
  static get is() {
  ...
  ready() {
    super.ready();
    this.addController(new TextAreaController(this, (input) => {
 ...
 */
//# sourceMappingURL=chunk-NNLJPDEP.js.map
