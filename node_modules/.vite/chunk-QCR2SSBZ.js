...
// node_modules/.pnpm/@vaadin/vaadin-list-mixin@22.0.2/node_modules/@vaadin/vaadin-list-mixin/vaadin-list-mixin.js
var ListMixin = (superClass) => class VaadinListMixin extends superClass {
  ...
  _searchKey(currentIdx, key) {
    ...
    if (!this.items.some((item) => item.textContent.replace(/[^\p{L}\p{Nd}]/gu, "").toLowerCase().indexOf(this._searchBuf) === 0)) {
      this._searchBuf = key.toLowerCase();
    }
 ...
 */
//# sourceMappingURL=chunk-QCR2SSBZ.js.map
