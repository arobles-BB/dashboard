...
// node_modules/.pnpm/@vaadin/polymer-legacy-adapter@22.0.2/node_modules/@vaadin/polymer-legacy-adapter/src/template-renderer-templatizer.js
var Templatizer = class extends PolymerElement {
  ...
  __createTemplateClass(properties) {
    ...
    const instanceProps = Object.keys(properties).reduce((accum, key) => {
      return __spreadProps(__spreadValues({}, accum), { [key]: true });
    }, {});
...
// node_modules/.pnpm/@vaadin/polymer-legacy-adapter@22.0.2/node_modules/@vaadin/polymer-legacy-adapter/src/template-renderer-grid-templatizer.js
...
// node_modules/.pnpm/@vaadin/polymer-legacy-adapter@22.0.2/node_modules/@vaadin/polymer-legacy-adapter/src/template-renderer.js
...
function showTemplateWarning(component) {
  ...
  console.warn(`WARNING: <template> inside <${component.localName}> is deprecated. Use a renderer function instead (see https://vaad.in/template-renderer)`);
