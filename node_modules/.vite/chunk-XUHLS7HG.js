...
import {
  PositionMixin
} from "./chunk-BC5TXSNW.js";
import {
  item
} from "./chunk-MVMJ7OQF.js";
import {
  OverlayElement
} from "./chunk-7WSTJGYG.js";
import {
  menuOverlayCore
} from "./chunk-CSA2HJ5Z.js";
import {
  overlay
} from "./chunk-Y5NNYWHZ.js";
import {
  isTouch
...
// node_modules/.pnpm/@vaadin/combo-box@22.0.2/node_modules/@vaadin/combo-box/theme/lumo/vaadin-combo-box-dropdown-styles.js
...
// node_modules/.pnpm/@vaadin/combo-box@22.0.2/node_modules/@vaadin/combo-box/theme/lumo/vaadin-combo-box-item-styles.js
...
// node_modules/.pnpm/@vaadin/combo-box@22.0.2/node_modules/@vaadin/combo-box/src/vaadin-combo-box-item.js
var ComboBoxItem = class extends ThemableMixin(DirMixin(PolymerElement)) {
  ...
  __rendererOrItemChanged(renderer, index, item2, _selected, _focused) {
...
// node_modules/.pnpm/@vaadin/combo-box@22.0.2/node_modules/@vaadin/combo-box/src/vaadin-combo-box-overlay.js
...
// node_modules/.pnpm/@vaadin/combo-box@22.0.2/node_modules/@vaadin/combo-box/src/vaadin-combo-box-scroller.js
...
// node_modules/.pnpm/@vaadin/combo-box@22.0.2/node_modules/@vaadin/combo-box/src/vaadin-combo-box-dropdown.js
var ComboBoxDropdown = class extends mixinBehaviors(IronResizableBehavior, PolymerElement) {
  static get is() {
...
// node_modules/.pnpm/@vaadin/combo-box@22.0.2/node_modules/@vaadin/combo-box/src/vaadin-combo-box-data-provider-mixin.js
...
// node_modules/.pnpm/@vaadin/combo-box@22.0.2/node_modules/@vaadin/combo-box/src/vaadin-combo-box-mixin.js
var ComboBoxMixin = (subclass) => class VaadinComboBoxMixinElement extends KeyboardMixin(InputMixin(DisabledMixin(subclass))) {
  static get properties() {
    return {
      opened: {
        type: Boolean,
  ...
  _commitValue() {
    ...
    if (items && this._focusedIndex > -1) {
      ...
      const itemsMatchedByLabel = this.filteredItems && this.filteredItems.filter((item2) => toLowerCase(this._getItemLabel(item2)) === toLowerCase(this._inputElementValue)) || [];
      if (this.allowCustomValue && !itemsMatchedByLabel.length) {
  ...
  _filteredItemsChanged(e) {
    if (e.path === "filteredItems" || e.path === "filteredItems.splices") {
      ...
      this._focusedIndex = this.opened || this.autoOpenDisabled ? this.$.dropdown.indexOfLabel(this.filter) : this._indexOfValue(this.value, this.filteredItems);
 ...
 */
//# sourceMappingURL=chunk-XUHLS7HG.js.map
